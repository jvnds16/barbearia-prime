    ...
    <header className="relative h-screen" id="home">
      ...
      <nav className="relative z-30 container mx-auto px-6 py-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="#booking" className="hover:text-amber-500 transition">
            Agendamento
          </a>
...
export function MobileMenu({
  ...
  return (
    <div
      className={`fixed top-0 right-0 h-full w-80 bg-zinc-950 z-50 transform transition-transform duration-300 ease-in-out ${open ? "translate-x-0" : "translate-x-full"}`}
    >
      <div className="p-6 h-full flex flex-col">
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-2 text-amber-500">
            <img
              src="/logo.png"
              className="h-8 w-8 bg-amber-500 rounded w-8 h-8"
            />
